...
public class DFC_MOCK_instanciatorTest {
	...
	public static void initialize(){
		if (isDFCavailable) {
			...
			QUERY_STRING_UNBOUNDED_DEFAULT = 
			 ...
			 QUERY_STRING_UNBOUNDED_DEFAULT = "select i_chronicle_id from dm_sysobject where r_object_type='dm_document' and r_creator_name!='Administrator' order by r_modify_date, i_chronicle_id";
