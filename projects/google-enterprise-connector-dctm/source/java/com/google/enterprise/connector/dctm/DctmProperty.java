 ...
 */
public class DctmProperty implements Property {
  ...
  public DctmProperty(String name, Value value) {
    this.name = name;
  ...
  public DctmProperty(String name, List valueList) {
    this.name = name;
    this.repeating = true;
    this.value = null;
  ...
  public DctmProperty(String name, String value) {
    this.name = name;
  ...
  public DctmProperty(String name, boolean value) {
    this.name = name;
  ...
  public DctmProperty(String name, long value) {
    this.name = name;
  ...
  public DctmProperty(String name, double value) {
    this.name = name;
